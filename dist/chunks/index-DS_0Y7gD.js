import { B as H, Y as L, W as b, P as M, I as S, D as w } from "./index-uMyjrk0Z.js";
import { a as C, x as p } from "./index-BjgkEHwo.js";
import { O as B, C as D } from "./index-Cb10foaC.js";
import { b as O } from "./index-DtI3zZ-b.js";
import { resolveComponent as x, openBlock as h, createElementBlock as f, mergeProps as a, createCommentVNode as v, createVNode as g, withCtx as m, Transition as E, createElementVNode as c } from "vue";
var R = `
    .p-colorpicker {
...
`, V = {
  ...
  beforeUnmount: function() {
    this.unbindOutsideClickListener(), this.unbindDragListeners(), this.unbindResizeListener(), this.scrollHandler && (this.scrollHandler.destroy(), this.scrollHandler = null), this.picker && this.autoZIndex && p.clear(this.picker), this.clearRefs();
  },
  mounted: function() {
    this.updateUI();
  },
  methods: {
    pickColor: function(e) {
      var t = this.colorSelector.getBoundingClientRect(), i = t.top + (window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0), l = t.left + document.body.scrollLeft, r = Math.floor(100 * Math.max(0, Math.min(150, (e.pageX || e.changedTouches[0].pageX) - l)) / 150), s = Math.floor(100 * (150 - Math.max(0, Math.min(150, (e.pageY || e.changedTouches[0].pageY) - i))) / 150);
    ...
    pickHue: function(e) {
      ...
      this.localHue = Math.floor(360 * (150 - Math.max(0, Math.min(150, (e.pageY || e.changedTouches[0].pageY) - t))) / 150), this.hsbValue = this.validateHSB({
        h: this.localHue,
        s: this.hsbValue.s,
        b: this.hsbValue.b
    ...
    RGBtoHSB: function(e) {
      var t = {
        ...
        s: 0,
        b: 0
      }, i = Math.min(e.r, e.g, e.b), l = Math.max(e.r, e.g, e.b), r = l - i;
      return t.b = l, t.s = l !== 0 ? 255 * r / l : 0, t.s !== 0 ? e.r === l ? t.h = (e.g - e.b) / r : e.g === l ? t.h = 2 + (e.b - e.r) / r : t.h = 4 + (e.r - e.g) / r : t.h = -1, t.h *= 60, t.h < 0 && (t.h += 360), t.s *= 100 / 255, t.b *= 100 / 255, t;
    },
    HSBtoRGB: function(e) {
      var t = {
        r: null,
        g: null,
        b: null
      }, i = Math.round(e.h), l = Math.round(e.s * 255 / 100), r = Math.round(e.b * 255 / 100);
      if (l === 0)
        t = {
          r,
          g: r,
        ...
        var s = r, o = (255 - l) * r / 255, u = (s - o) * (i % 60) / 60;
        i === 360 && (i = 0), i < 60 ? (t.r = s, t.b = o, t.g = o + u) : i < 120 ? (t.g = s, t.b = o, t.r = s - u) : i < 180 ? (t.g = s, t.r = o, t.b = o + u) : i < 240 ? (t.b = s, t.r = o, t.g = s - u) : i < 300 ? (t.b = s, t.g = o, t.r = o + u) : i < 360 ? (t.r = s, t.g = o, t.b = s - u) : (t.r = 0, t.g = 0, t.b = 0);
      }
      return {
        r: Math.round(t.r),
        g: Math.round(t.g),
    ...
    toHSB: function(e) {
      ...
      return t.s === 0 || t.b === 0 ? t.h = this.localHue : this.localHue = t.h, t;
    },
    onOverlayEnter: function(e) {
      this.updateUI(), this.alignOverlay(), this.bindOutsideClickListener(), this.bindScrollListener(), this.bindResizeListener(), this.autoZIndex && p.set("overlay", e, this.baseZIndex + this.$primevue.config.zIndex.overlay), this.$attrSelector && e.setAttribute(this.$attrSelector, ""), this.$emit("show");
    },
    ...
    alignOverlay: function() {
      this.appendTo === "self" ? S(this.picker, this.$refs.input) : w(this.picker, this.$refs.input);
    },
    ...
    onInputBlur: function(e) {
      var t, i;
      (t = (i = this.formField).onBlur) === null || t === void 0 || t.call(i);
    },
    onColorMousedown: function(e) {
      this.disabled || (this.bindDragListeners(), this.onColorDragStart(e));
    },
    onColorDragStart: function(e) {
      this.disabled || (this.colorDragging = !0, this.pickColor(e), this.$el.setAttribute("p-colorpicker-dragging", "true"), !this.isUnstyled && b(this.$el, "p-colorpicker-dragging"), e.preventDefault());
    },
    onDrag: function(e) {
      this.colorDragging && (this.pickColor(e), e.preventDefault()), this.hueDragging && (this.pickHue(e), e.preventDefault());
    },
    onDragEnd: function() {
      this.colorDragging = !1, this.hueDragging = !1, this.$el.setAttribute("p-colorpicker-dragging", "false"), !this.isUnstyled && M(this.$el, "p-colorpicker-dragging"), this.unbindDragListeners();
    },
    onHueMousedown: function(e) {
      this.disabled || (this.bindDragListeners(), this.onHueDragStart(e));
    },
    onHueDragStart: function(e) {
      this.disabled || (this.hueDragging = !0, this.pickHue(e), !this.isUnstyled && b(this.$el, "p-colorpicker-dragging"), e.preventDefault());
    },
    ...
    bindOutsideClickListener: function() {
      ...
      this.outsideClickListener || (this.outsideClickListener = function(t) {
        e.overlayVisible && e.picker && !e.picker.contains(t.target) && !e.isInputClicked(t) && (e.overlayVisible = !1);
    ...
    bindResizeListener: function() {
      ...
      this.resizeListener || (this.resizeListener = function() {
        e.overlayVisible && !L() && (e.overlayVisible = !1);
...
function y(n) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? k(Object(t), !0).forEach(function(i) {
      T(n, i, t[i]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t)) : k(Object(t)).forEach(function(i) {
...
function T(n, e, t) {
  return (e = X(e)) in n ? Object.defineProperty(n, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : n[e] = t, n;
}
function X(n) {
  var e = j(n, "string");
...
var z = ["id", "tabindex", "disabled"];
function G(n, e, t, i, l, r) {
  var s = x("Portal");
  return h(), f("div", a({
    ref: "container",
    class: n.cx("root")
  }, n.ptmi("root")), [n.inline ? v("", !0) : (h(), f("input", a({
    key: 0,
    ref: "input",
    id: n.inputId,
    type: "text",
    ...
    default: m(function() {
      return [g(E, a({
        ...
        default: m(function() {
          return [n.inline || l.overlayVisible ? (h(), f("div", a({
            key: 0,
            ref: r.pickerRef,
            class: [n.cx("panel"), n.panelClass, n.overlayClass],
            onClick: e[11] || (e[11] = function() {
              return r.onOverlayClick && r.onOverlayClick.apply(r, arguments);
            })
          }, y(y({}, n.ptm("panel")), n.ptm("overlay"))), [c("div", a({
            class: n.cx("content")
          }, n.ptm("content")), [c("div", a({
            ref: r.colorSelectorRef,
            class: n.cx("colorSelector"),
            onMousedown: e[3] || (e[3] = function(o) {
              return r.onColorMousedown(o);
            }),
            onTouchstart: e[4] || (e[4] = function(o) {
              return r.onColorDragStart(o);
            }),
            onTouchmove: e[5] || (e[5] = function(o) {
              return r.onDrag(o);
            }),
            onTouchend: e[6] || (e[6] = function(o) {
              return r.onDragEnd();
            })
          }, n.ptm("colorSelector")), [c("div", a({
            class: n.cx("colorBackground")
          }, n.ptm("colorBackground")), [c("div", a({
            ref: r.colorHandleRef,
            class: n.cx("colorHandle")
          }, n.ptm("colorHandle")), null, 16)], 16)], 16), c("div", a({
            ref: r.hueViewRef,
            class: n.cx("hue"),
            onMousedown: e[7] || (e[7] = function(o) {
              return r.onHueMousedown(o);
            }),
            onTouchstart: e[8] || (e[8] = function(o) {
              return r.onHueDragStart(o);
            }),
            onTouchmove: e[9] || (e[9] = function(o) {
              return r.onDrag(o);
            }),
            onTouchend: e[10] || (e[10] = function(o) {
              return r.onDragEnd();
            })
          }, n.ptm("hue")), [c("div", a({
            ref: r.hueHandleRef,
            class: n.cx("hueHandle")
          }, n.ptm("hueHandle")), null, 16)], 16)], 16)], 16)) : v("", !0)];
        }),
        _: 1
...
//# sourceMappingURL=index-DS_0Y7gD.js.map
