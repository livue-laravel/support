import { B as Z, s as A, M as F, z as _, b as O, k as ee, Y as te, I as ne, v as ie, D as oe, S as le, l as re, p as k } from "./index-uMyjrk0Z.js";
import { R as ae, b as se, a as ue, x as R } from "./index-BjgkEHwo.js";
import { C as de, O as pe } from "./index-Cb10foaC.js";
import { d as ce, l as fe, c as he, s as me } from "./index-DtI3zZ-b.js";
import { s as ye } from "./index-D-cypkd-.js";
import { s as ge } from "./index-Bbeg0KN4.js";
import { resolveComponent as I, resolveDirective as be, openBlock as s, createElementBlock as c, mergeProps as r, createBlock as z, normalizeStyle as ve, normalizeClass as w, createCommentVNode as v, renderSlot as h, createVNode as C, Fragment as B, renderList as H, withCtx as x, createElementVNode as M, resolveDynamicComponent as Oe, toDisplayString as L, Transition as Ie, createSlots as we, createTextVNode as j, withDirectives as Se } from "vue";
...
`, Ce = {
  ...
  root: function(e) {
    ...
    return ["p-autocomplete p-component p-inputwrapper", {
      "p-invalid": n.$invalid,
      "p-focus": n.focused,
      "p-inputwrapper-filled": n.$filled || A(n.inputValue),
  ...
  option: function(e) {
    var n = e.instance, o = e.option, l = e.i, i = e.getItemOptions;
    return ["p-autocomplete-option", {
      "p-autocomplete-option-selected": n.isSelected(o),
      "p-focus": n.focusedOptionIndex === n.getOptionIndex(l, i),
...
var Ee = {
  ...
  methods: {
    ...
    show: function(e) {
      this.$emit("before-show"), this.dirty = !0, this.overlayVisible = !0, this.focusedOptionIndex = this.focusedOptionIndex !== -1 ? this.focusedOptionIndex : this.autoOptionFocus ? this.findFirstFocusedOptionIndex() : -1, e && O(this.multiple ? this.$refs.focusInput : this.$refs.focusInput.$el);
    },
    hide: function(e) {
      var n = this, o = function() {
        var i;
        n.$emit("before-hide"), n.dirty = e, n.overlayVisible = !1, n.clicked = !1, n.focusedOptionIndex = -1, e && O(n.multiple ? n.$refs.focusInput : (i = n.$refs.focusInput) === null || i === void 0 ? void 0 : i.$el);
      };
      setTimeout(function() {
        o();
      }, 0);
    ...
    onBlur: function(e) {
      var n, o;
      this.dirty = !1, this.focused = !1, this.focusedOptionIndex = -1, this.$emit("blur", e), (n = (o = this.formField).onBlur) === null || n === void 0 || n.call(o);
    },
    ...
    onInput: function(e) {
      ...
      if (this.typeahead) {
        ...
        this.multiple || this.updateModel(e, o), o.length === 0 ? (this.searching = !1, this.hide(), this.$emit("clear")) : o.length >= this.minLength ? (this.focusedOptionIndex = -1, this.searchTimeout = setTimeout(function() {
          n.search(e, o, "input");
    ...
    onChange: function(e) {
      ...
      if (this.forceSelection) {
        ...
        if (this.visibleOptions && !this.multiple) {
          var l, i = this.multiple ? this.$refs.focusInput.value : (l = this.$refs.focusInput) === null || l === void 0 || (l = l.$el) === null || l === void 0 ? void 0 : l.value, p = this.visibleOptions.find(function(P) {
            return n.isOptionMatched(P, i || "");
          });
          p !== void 0 && (o = !0, !this.isSelected(p) && this.onOptionSelect(e, p));
        }
        if (!o) {
          if (this.multiple)
            this.$refs.focusInput.value = "";
          else {
            var m, y = (m = this.$refs.focusInput) === null || m === void 0 ? void 0 : m.$el;
            y && (y.value = "");
          }
    ...
    onContainerClick: function(e) {
      this.clicked = !0, !(this.disabled || this.searching || this.loading || this.isDropdownClicked(e)) && (!this.overlay || !this.overlay.contains(e.target)) && O(this.multiple ? this.$refs.focusInput : this.$refs.focusInput.$el);
    },
    onDropdownClick: function(e) {
      ...
      if (this.overlayVisible)
        ...
        O(o), n = o.value, this.dropdownMode === "blank" ? this.search(e, "", "dropdown") : this.dropdownMode === "current" && this.search(e, n, "dropdown");
      }
    ...
    onOptionSelect: function(e, n) {
      var o = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, l = this.getOptionValue(n);
      this.multiple ? (this.$refs.focusInput.value = "", this.isSelected(n) || this.updateModel(e, [].concat(T(this.d_value || []), [l]))) : this.updateModel(e, l), this.$emit("item-select", {
        originalEvent: e,
        value: n
    ...
    onOptionSelectRange: function(e) {
      var n = this, o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : -1, l = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : -1;
      if (o === -1 && (o = this.findNearestSelectedOptionIndex(l, !0)), l === -1 && (l = this.findNearestSelectedOptionIndex(o)), o !== -1 && l !== -1) {
        var i = Math.min(o, l), p = Math.max(o, l), m = this.visibleOptions.slice(i, p + 1).filter(function(y) {
          return n.isValidOption(y);
        }).filter(function(y) {
          return !n.isSelected(y);
        }).map(function(y) {
          return n.getOptionValue(y);
        });
        this.updateModel(e, [].concat(T(this.d_value || []), T(m)));
      }
    },
    ...
    onArrowLeftKey: function(e) {
      ...
      this.focusedOptionIndex = -1, this.multiple && (re(n.value) && this.$filled ? (O(this.$refs.multiContainer), this.focusedMultipleOptionIndex = this.d_value.length) : e.stopPropagation());
    },
    onArrowRightKey: function(e) {
      this.focusedOptionIndex = -1, this.multiple && e.stopPropagation();
    },
    onHomeKey: function(e) {
      var n = e.currentTarget, o = n.value.length, l = e.metaKey || e.ctrlKey, i = this.findFirstOptionIndex();
      this.multiple && e.shiftKey && l && this.onOptionSelectRange(e, i, this.startRangeIndex), n.setSelectionRange(0, e.shiftKey ? o : 0), this.focusedOptionIndex = -1, e.preventDefault();
    },
    onEndKey: function(e) {
      var n = e.currentTarget, o = n.value.length, l = e.metaKey || e.ctrlKey, i = this.findLastOptionIndex();
      this.multiple && e.shiftKey && l && this.onOptionSelectRange(e, this.startRangeIndex, i), n.setSelectionRange(e.shiftKey ? 0 : o, o), this.focusedOptionIndex = -1, e.preventDefault();
    },
    ...
    onBackspaceKey: function(e) {
      if (this.multiple) {
        if (A(this.d_value) && !this.$refs.focusInput.value) {
          var n = this.d_value[this.d_value.length - 1], o = this.d_value.slice(0, -1);
          this.writeValue(o, e), this.$emit("item-unselect", {
            originalEvent: e,
            value: n
    ...
    onArrowRightKeyOnMultiple: function() {
      this.focusedMultipleOptionIndex++, this.focusedMultipleOptionIndex > this.d_value.length - 1 && (this.focusedMultipleOptionIndex = -1, O(this.$refs.focusInput));
    },
    ...
    onOverlayEnter: function(e) {
      R.set("overlay", e, this.$primevue.config.zIndex.overlay), le(e, {
        position: "absolute",
        top: "0"
    ...
    alignOverlay: function() {
      ...
      this.appendTo === "self" ? ne(this.overlay, e) : (this.overlay.style.minWidth = ie(e) + "px", oe(this.overlay, e));
    },
    ...
    bindScrollListener: function() {
      var e = this;
      this.scrollHandler || (this.scrollHandler = new de(this.$refs.container, function() {
    ...
    findNextOptionIndex: function(e) {
      var n = this, o = e < this.visibleOptions.length - 1 ? this.visibleOptions.slice(e + 1).findIndex(function(l) {
        return n.isValidOption(l);
      }) : -1;
      return o > -1 ? o + e + 1 : e;
    },
    findPrevOptionIndex: function(e) {
      var n = this, o = e > 0 ? F(this.visibleOptions.slice(0, e), function(l) {
        return n.isValidOption(l);
      }) : -1;
      return o > -1 ? o : e;
    },
    ...
    removeOption: function(e, n) {
      var o = this, l = this.d_value[n], i = this.d_value.filter(function(p, m) {
        return m !== n;
      }).map(function(p) {
        return o.getOptionValue(p);
      });
      this.updateModel(e, i), this.$emit("item-unselect", {
        ...
        originalEvent: e,
        value: l
      }), this.dirty = !0, O(this.multiple ? this.$refs.focusInput : this.$refs.focusInput.$el);
    },
    ...
    scrollInView: function() {
      ...
      this.$nextTick(function() {
        var o = n !== -1 ? "".concat(e.$id, "_").concat(n) : e.focusedOptionId, l = _(e.list, 'li[id="'.concat(o, '"]'));
    ...
    flatOptions: function(e) {
      var n = this;
      return (e || []).reduce(function(o, l, i) {
        o.push({
          optionGroup: l,
          group: !0,
          index: i
        });
        var p = n.getOptionGroupChildren(l);
        return p && p.forEach(function(m) {
          return o.push(m);
        }), o;
      }, []);
    },
    ...
    findNextSelectedOptionIndex: function(e) {
      var n = this, o = this.$filled && e < this.visibleOptions.length - 1 ? this.visibleOptions.slice(e + 1).findIndex(function(l) {
        return n.isValidSelectedOption(l);
      }) : -1;
      return o > -1 ? o + e + 1 : -1;
    },
    findPrevSelectedOptionIndex: function(e) {
      var n = this, o = this.$filled && e > 0 ? F(this.visibleOptions.slice(0, e), function(l) {
        return n.isValidSelectedOption(l);
      }) : -1;
      return o > -1 ? o : -1;
    },
    findNearestSelectedOptionIndex: function(e) {
      ...
      return this.$filled && (n ? (o = this.findPrevSelectedOptionIndex(e), o = o === -1 ? this.findNextSelectedOptionIndex(e) : o) : (o = this.findNextSelectedOptionIndex(e), o = o === -1 ? this.findPrevSelectedOptionIndex(e) : o)), o > -1 ? o : e;
    }
  },
  computed: {
    ...
    searchResultMessageText: function() {
      return A(this.visibleOptions) && this.overlayVisible ? this.searchMessageText.replaceAll("{0}", this.visibleOptions.length) : this.emptySearchMessageText;
    },
    ...
    overlayDataP: function() {
      return G(U({}, "portal-" + this.appendTo, "portal-" + this.appendTo));
    },
...
function Fe(t, e, n) {
  return (e = Re(e)) in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function Re(t) {
  var e = ze(t, "string");
...
var Be = ["data-p"], je = ["aria-activedescendant", "data-p-has-dropdown", "data-p"], Ge = ["id", "aria-label", "aria-setsize", "aria-posinset"], Ne = ["id", "placeholder", "tabindex", "disabled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "aria-invalid"], He = ["data-p-has-dropdown"], Ue = ["disabled", "aria-expanded", "aria-controls"], $e = ["id", "data-p"], qe = ["id", "aria-label"], We = ["id"], Ye = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove", "data-p-selected", "data-p-focused", "data-p-disabled"];
function Je(t, e, n, o, l, i) {
  var p = I("InputText"), m = I("TimesIcon"), y = I("Chip"), P = I("SpinnerIcon"), W = I("VirtualScroller"), Y = I("Portal"), J = be("ripple");
  return s(), c("div", r({
    ref: "container",
    class: t.cx("root"),
    style: t.sx("root"),
  ...
  }, t.ptmi("root")), [t.multiple ? v("", !0) : (s(), z(p, {
    key: 0,
    ref: "focusInput",
    id: t.inputId,
    type: "text",
    ...
    "aria-controls": l.overlayVisible ? i.panelId : void 0,
  ...
  }, null, 8, ["id", "name", "class", "style", "defaultValue", "placeholder", "tabindex", "fluid", "disabled", "size", "invalid", "variant", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "onFocus", "onBlur", "onKeydown", "onInput", "onChange", "unstyled", "data-p-has-dropdown", "pt"])), i.isClearIconVisible ? h(t.$slots, "clearicon", {
    key: 1,
    class: w(t.cx("clearIcon")),
    ...
    "aria-activedescendant": l.focused ? i.focusedMultipleOptionId : void 0,
  ...
  }, t.ptm("inputMultiple")), [(s(!0), c(B, null, H(t.d_value, function(d, a) {
    return s(), c("li", r({
      key: "".concat(a, "_").concat(i.getOptionLabel(d)),
      id: t.$id + "_multiple_option_" + a,
      class: t.cx("chipItem", {
        i: a
      }),
      role: "option",
      "aria-label": i.getOptionLabel(d),
      "aria-selected": !0,
      "aria-setsize": t.d_value.length,
      "aria-posinset": a + 1
    }, {
      ref_for: !0
    }, t.ptm("chipItem")), [h(t.$slots, "chip", r({
      class: t.cx("pcChip"),
      value: d,
      index: a,
      removeCallback: function(g) {
        return i.removeOption(g, a);
      }
    }, {
      ref_for: !0
      ...
      return [C(y, {
        ...
        "data-p-focused": l.focusedMultipleOptionIndex === a,
        pt: t.ptm("pcChip")
      }, {
        removeicon: x(function() {
          return [h(t.$slots, t.$slots.chipicon ? "chipicon" : "removetokenicon", {
  ...
  }, t.ptm("input")), null, 16, Ne)], 16)], 16, je)) : v("", !0), l.searching || t.loading ? h(t.$slots, t.$slots.loader ? "loader" : "loadingicon", {
    key: 3,
    class: w(t.cx("loader"))
  }, function() {
    return [t.loader || t.loadingIcon ? (s(), c("i", r({
      key: 0,
      class: ["pi-spin", t.cx("loader"), t.loader, t.loadingIcon],
      "aria-hidden": "true",
      "data-p-has-dropdown": t.dropdown
    }, t.ptm("loader")), null, 16, He)) : t.loading ? (s(), z(P, r({
      key: 1,
      class: t.cx("loader"),
      spin: "",
      "aria-hidden": "true",
      "data-p-has-dropdown": t.dropdown
    }, t.ptm("loader")), null, 16, ["class", "data-p-has-dropdown"])) : v("", !0)];
  }) : v("", !0), h(t.$slots, t.$slots.dropdown ? "dropdown" : "dropdownbutton", {
    toggleCallback: function(a) {
      return i.onDropdownClick(a);
    }
  }, function() {
    return [t.dropdown ? (s(), c("button", r({
      key: 0,
      ref: "dropdownButton",
      type: "button",
    ...
    }, t.ptm("dropdown")), [h(t.$slots, "dropdownicon", {
      class: w(t.dropdownIcon)
    }, function() {
      return [(s(), z(Oe(t.dropdownIcon ? "span" : "ChevronDownIcon"), r({
        class: t.dropdownIcon
      }, t.ptm("dropdownIcon")), null, 16, ["class"]))];
    })], 16, Ue)) : v("", !0)];
  }), t.typeahead ? (s(), c("span", r({
    key: 4,
    role: "status",
    "aria-live": "polite",
  ...
  }), L(i.searchResultMessageText), 17)) : v("", !0), C(Y, {
    appendTo: t.appendTo
  }, {
    default: x(function() {
      return [C(Ie, r({
        ...
        default: x(function() {
          return [l.overlayVisible ? (s(), c("div", r({
            key: 0,
            ref: i.overlayRef,
            id: i.panelId,
            class: [t.cx("overlay"), t.panelClass, t.overlayClass],
            style: q(q({}, t.panelStyle), t.overlayStyle),
          ...
          }, t.ptm("overlay")), [h(t.$slots, "header", {
            value: t.d_value,
            ...
            content: x(function(d) {
              var a = d.styleClass, D = d.contentRef, g = d.items, b = d.getItemOptions, Q = d.contentStyle, V = d.itemSize;
              return [M("ul", r({
                ref: function(f) {
                  return i.listRef(f, D);
                },
                id: t.$id + "_list",
                class: [t.cx("list"), a],
                style: Q,
              ...
              }, t.ptm("list")), [(s(!0), c(B, null, H(g, function(u, f) {
                return s(), c(B, {
                  key: i.getOptionRenderKey(u, i.getOptionIndex(f, b))
                }, [i.isOptionGroup(u) ? (s(), c("li", r({
                  key: 0,
                  id: t.$id + "_" + i.getOptionIndex(f, b),
                  style: {
                  ...
                  ref_for: !0
                }, t.ptm("optionGroup")), [h(t.$slots, "optiongroup", {
                  option: u.optionGroup,
                  index: i.getOptionIndex(f, b)
                }, function() {
                  return [j(L(i.getOptionGroupLabel(u.optionGroup)), 1)];
                })], 16, We)) : Se((s(), c("li", r({
                  key: 1,
                  id: t.$id + "_" + i.getOptionIndex(f, b),
                  style: {
                  ...
                  role: "option",
                  "aria-label": i.getOptionLabel(u),
                  "aria-selected": i.isSelected(u),
                  "aria-disabled": i.isOptionDisabled(u),
                  "aria-setsize": i.ariaSetSize,
                  "aria-posinset": i.getAriaPosInset(i.getOptionIndex(f, b)),
                  onClick: function(E) {
                    return i.onOptionSelect(E, u);
                  },
                  onMousemove: function(E) {
                    return i.onOptionMouseMove(E, i.getOptionIndex(f, b));
                  },
                  "data-p-selected": i.isSelected(u),
                  "data-p-focused": l.focusedOptionIndex === i.getOptionIndex(f, b),
                  "data-p-disabled": i.isOptionDisabled(u)
                }, {
                  ref_for: !0
                }, i.getPTOptions(u, b, f, "option")), [h(t.$slots, "option", {
                  option: u,
                  index: i.getOptionIndex(f, b)
                }, function() {
                  return [j(L(i.getOptionLabel(u)), 1)];
                })], 16, Ye)), [[J]])], 64);
              }), 128)), t.showEmptyMessage && (!g || g && g.length === 0) ? (s(), c("li", r({
                key: 0,
                class: t.cx("emptyMessage"),
                role: "option"
              }, t.ptm("emptyMessage")), [h(t.$slots, "empty", {}, function() {
                return [j(L(i.searchResultMessageText), 1)];
              })], 16)) : v("", !0)], 16, qe)];
            }),
            _: 2
          }, [t.$slots.loader ? {
            ...
            key: "0"
          } : void 0]), 1040, ["style", "items", "disabled", "pt"])], 16), h(t.$slots, "footer", {
            value: t.d_value,
            suggestions: i.visibleOptions
          }), M("span", r({
            role: "status",
            ...
            "data-p-hidden-accessible": !0
          }), L(i.selectedMessageText), 17)], 16, $e)) : v("", !0)];
        }),
        _: 3
...
//# sourceMappingURL=index-DNKI44wO.js.map
