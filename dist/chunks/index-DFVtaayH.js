import { s as l } from "./index-BjgkEHwo.js";
import { openBlock as i, createElementBlock as u, mergeProps as s, createElementVNode as C } from "vue";
var c = {
  name: "AngleDoubleDownIcon",
  extends: l
};
function d(r) {
  return A(r) || b(r) || m(r) || y();
}
function y() {
...
function L(r, t) {
  if (r) {
    ...
    var e = {}.toString.call(r).slice(8, -1);
    return e === "Object" && r.constructor && (e = r.constructor.name), e === "Map" || e === "Set" ? Array.from(r) : e === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? a(r, t) : void 0;
  }
}
function w(r) {
  if (typeof Symbol < "u" && r[Symbol.iterator] != null || r["@@iterator"] != null) return Array.from(r);
...
//# sourceMappingURL=index-DFVtaayH.js.map
