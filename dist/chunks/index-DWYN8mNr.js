import { B as m, Q as b, V as p, j as v, n as c } from "./index-uMyjrk0Z.js";
import { b as y } from "./index-DtI3zZ-b.js";
import { openBlock as d, createElementBlock as u, mergeProps as l, createElementVNode as w, createCommentVNode as h } from "vue";
import { f as D } from "./index-CoIgDweF.js";
var S = `
    .p-slider {
        display: block;
        position: relative;
...
function B(n, e, t) {
  return (e = M(e)) in n ? Object.defineProperty(n, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : n[e] = t, n;
}
function M(n) {
  var e = A(n, "string");
...
function x(n, e) {
  if (n) {
    ...
    return t === "Object" && n.constructor && (t = n.constructor.name), t === "Map" || t === "Set" ? Array.from(n) : t === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? f(n, e) : void 0;
  }
}
function H(n) {
...
var I = {
  ...
  methods: {
    updateDomData: function() {
      ...
      this.initX = e.left + v(), this.initY = e.top + c(), this.barWidth = this.$el.offsetWidth, this.barHeight = this.$el.offsetHeight;
    },
    setValue: function(e) {
      var t, r = e.touches ? e.touches[0].pageX : e.pageX, s = e.touches ? e.touches[0].pageY : e.pageY;
      this.orientation === "horizontal" ? p(this.$el) ? t = (this.initX + this.barWidth - r) * 100 / this.barWidth : t = (r - this.initX) * 100 / this.barWidth : t = (this.initY + this.barHeight - s) * 100 / this.barHeight;
      var i = (this.max - this.min) * (t / 100) + this.min;
      if (this.step) {
        var a = this.range ? this.value[this.handleIndex] : this.value, g = i - a;
        g < 0 ? i = a + Math.ceil(i / this.step - a / this.step) * this.step : g > 0 && (i = a + Math.floor(i / this.step - a / this.step) * this.step);
      } else
        i = Math.floor(i);
      this.updateModel(e, i);
    },
    updateModel: function(e, t) {
      var r = Math.round(t * 100) / 100, s;
      this.range ? (s = this.value ? V(this.value) : [], this.handleIndex == 0 ? (r < this.min ? r = this.min : r >= this.max && (r = this.max), s[0] = r) : (r > this.max ? r = this.max : r <= this.min && (r = this.min), s[1] = r)) : (r < this.min ? r = this.min : r > this.max && (r = this.max), s = r), this.writeValue(s, e), this.$emit("change", s);
    },
    ...
    onBarClick: function(e) {
      this.disabled || b(e.target, "data-pc-section") !== "handle" && (this.updateDomData(), this.setValue(e));
    },
    ...
    onBlur: function(e, t) {
      var r, s;
      (r = (s = this.formField).onBlur) === null || r === void 0 || r.call(s, e);
    },
    decrementValue: function(e, t) {
      var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1, s;
      this.range ? this.step ? s = this.value[t] - this.step : s = this.value[t] - 1 : this.step ? s = this.value - this.step : !this.step && r ? s = this.value - 10 : s = this.value - 1, this.updateModel(e, s), e.preventDefault();
    },
    ...
    rangeStyle: function() {
      if (this.range) {
        var e = this.rangeEndPosition > this.rangeStartPosition ? this.rangeEndPosition - this.rangeStartPosition : this.rangeStartPosition - this.rangeEndPosition, t = this.rangeEndPosition > this.rangeStartPosition ? this.rangeStartPosition : this.rangeEndPosition;
  ...
  computed: {
    value: function() {
      ...
      if (this.range) {
        var t, r, s, i;
        return [(t = (r = this.d_value) === null || r === void 0 ? void 0 : r[0]) !== null && t !== void 0 ? t : this.min, (s = (i = this.d_value) === null || i === void 0 ? void 0 : i[1]) !== null && s !== void 0 ? s : this.max];
      }
...
function W(n, e, t, r, s, i) {
  return d(), u("div", l({
    ...
    class: n.cx("range"),
    style: [n.sx("range"), i.rangeStyle()]
  }, n.ptm("range"), {
    "data-p": i.dataP
  }), null, 16, C), n.range ? h("", !0) : (d(), u("span", l({
    key: 0,
    class: n.cx("handle"),
    style: [n.sx("handle"), i.handleStyle()],
    onTouchstartPassive: e[0] || (e[0] = function(a) {
      return i.onDragStart(a);
    }),
    onTouchmovePassive: e[1] || (e[1] = function(a) {
      return i.onDrag(a);
    }),
    onTouchend: e[2] || (e[2] = function(a) {
      return i.onDragEnd(a);
    }),
    onMousedown: e[3] || (e[3] = function(a) {
      return i.onMouseDown(a);
    }),
    ...
    "data-p": i.dataP
  }), null, 16, j)), n.range ? (d(), u("span", l({
    key: 1,
    class: n.cx("handle"),
    style: [n.sx("handle"), i.rangeStartHandleStyle()],
    onTouchstartPassive: e[6] || (e[6] = function(a) {
      return i.onDragStart(a, 0);
    }),
    ...
    onMousedown: e[9] || (e[9] = function(a) {
      return i.onMouseDown(a, 0);
    }),
    onKeydown: e[10] || (e[10] = function(a) {
      return i.onKeyDown(a, 0);
    }),
    ...
    role: "slider",
    "aria-valuemin": n.min,
    "aria-valuenow": n.d_value ? n.d_value[0] : null,
    "aria-valuemax": n.max,
    "aria-labelledby": n.ariaLabelledby,
    "aria-label": n.ariaLabel,
    "aria-orientation": n.orientation
    ...
    "data-p": i.dataP
  }), null, 16, N)) : h("", !0), n.range ? (d(), u("span", l({
    key: 2,
    class: n.cx("handle"),
    style: [n.sx("handle"), i.rangeEndHandleStyle()],
    onTouchstartPassive: e[12] || (e[12] = function(a) {
      return i.onDragStart(a, 1);
    }),
    ...
    onMousedown: e[15] || (e[15] = function(a) {
      return i.onMouseDown(a, 1);
    }),
    onKeydown: e[16] || (e[16] = function(a) {
      return i.onKeyDown(a, 1);
    }),
    ...
    role: "slider",
    "aria-valuemin": n.min,
    "aria-valuenow": n.d_value ? n.d_value[1] : null,
    "aria-valuemax": n.max,
    "aria-labelledby": n.ariaLabelledby,
    "aria-label": n.ariaLabel,
    "aria-orientation": n.orientation
...
//# sourceMappingURL=index-DWYN8mNr.js.map
